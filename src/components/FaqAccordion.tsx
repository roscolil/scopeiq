...
const faqData = [
  {
    question: 'What types of documents can I analyze with ScopeIQ?',
    answer:
      'ScopeIQ supports a wide range of document formats including PDF, DOCX, TXT, JPG, and PNG files. Our platform is particularly optimized for construction documents such as plans, specifications, and quotes.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Absolutely. ScopeIQ allows you to create projects and organize related documents together, making it easier to manage complex construction jobs with multiple document sets.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, ScopeIQ supports team collaboration with shared projects, document access controls, and the ability to share insights across your organization.',
  },
]
