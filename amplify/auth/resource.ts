...
export const auth = defineAuth({
  loginWith: {
    email: {
      ...
      verificationEmailSubject: 'Welcome to ScopeIQ - Verify Your Account',
      verificationEmailBody: createCode =>
        `Welcome to ScopeIQ! Use this verification code to complete your account setup: ${createCode()}`,
    },
  },
