...
export const handler: Schema['sendInvitationEmail']['functionHandler'] =
  async event => {
    try {
      ...
      const subject = `Invitation to join ${companyName} on JACK by Exelion`
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p>Join your team on JACK by Exelion</p>
            </div>
            
            <div class="content">
              <h2>Hello ${recipientName || recipientEmail}!</h2>

              <p><strong>${inviterName}</strong> has invited you to join <strong>${companyName}</strong> on JACK by Exelion.</p>

              <p>You've been assigned the role of: <span class="role-badge">${role}</span></p>
              
              <p>JACK by Exelion helps teams collaborate on documents with AI-powered insights and streamlined workflows.</p>
            ...
            <div class="footer">
              ...
              <p>&copy; 2025 JACK by Exelion. All rights reserved.</p>
            </div>
          </div>
        </body>
      </html>
    `
      ...
      const textBody = `
You're invited to join ${companyName} on JACK by Exelion!

${inviterName} has invited you to join ${companyName} on JACK by Exelion as a ${role}.

JACK by Exelion helps teams collaborate on documents with AI-powered insights and streamlined workflows.
...
© 2025 JACK by Exelion. All rights reserved.
    `
